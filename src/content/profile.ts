// Preencha apenas com seus endereços profissionais reais.
// Canais vazios ficam ocultos; nenhum botão aponta para perfis de exemplo.
export const profile = {
  name: 'Filipe Barbosa',
  role: 'Desenvolvedor web',
  location: 'Itapira, São Paulo',
